...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.RangeSlider(0, 10000, 1, id='payload-slider', marks={i: str(i) for i in range(0, 10001, 2500)}, value=[min_payload, max_payload]),
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        if entered_site == 'site1':
            ...
            Count.columns = ['label', 'class'] 
            fig = px.pie(Count, values='class',
            names='label',
